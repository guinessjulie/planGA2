...
def create_gui():
    # Create main window
    root = tk.Tk()
    root.title("Options For Mass Plan")
    ...
    fitness_frame = ttk.LabelFrame(main_frame, text="Fitness")
    fitness_frame.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

    mass_frame = ttk.LabelFrame(main_frame, text="Objectives")
    mass_frame.grid(row=1, column=0, padx=10, pady=10, sticky="nsew")

    gaparams_frame = ttk.LabelFrame(main_frame, text="GA Parameters")
    gaparams_frame.grid(row=1, column=1, padx=10, pady=10, sticky="nsew")

    optional_frame = ttk.LabelFrame(main_frame, text="Optional")
    optional_frame.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")

    # Fitness section
    ttk.Label(fitness_frame, text="wall_list:").grid(row=0, column=0, sticky='w')
    wall_list_entry = ttk.Entry(fitness_frame)
    wall_list_entry.grid(row=0, column=1)
    ...
    road_side_entry.grid(row=1, column=1)
    ...
    adjacent_land_entry.grid(row=2, column=1)
    ...
    optimal_aspect_ratio_entry.grid(row=3, column=1)
    ...
    fitoption_entry.grid(row=4, column=1)
    ...
    required_faratio_entry.grid(row=2, column=1)
    ...
    cell_length_entry.grid(row=3, column=1)
    ...
    max_area_entry.grid(row=4, column=1)
    ...
    min_area_entry.grid(row=5, column=1)
    ...
    adjacent_distance_south_entry.grid(row=6, column=1)
    ...
    road_distance_entry.grid(row=7, column=1)
    ...
    road_width_entry.grid(row=8, column=1)
    ...
    height_diff_south_entry.grid(row=9, column=1)
    ...
    south_gap_entry.grid(row=10, column=1)
    ...
    north_gap_entry.grid(row=11, column=1)
    ...
    west_gap_entry.grid(row=12, column=1)
    ...
    east_gap_entry.grid(row=13, column=1)
    ...
    wall_height_entry.grid(row=14, column=1)
    ...
    setback_requirement_entry.grid(row=15, column=1)
    ...
    numfig_entry.grid(row=16, column=1)
    ...
    numcell_entry.grid(row=17, column=1)
    ...
    expandsize_entry.grid(row=0, column=1)
    ...
    numcross_entry.grid(row=1, column=1)
    ...
    mutationrate_entry.grid(row=2, column=1)
    ...
    ngeneration_entry.grid(row=3, column=1)
    ...
    population_size_entry.grid(row=4, column=1)
    ...
    crossoverchance_entry.grid(row=5, column=1)
    ...
    dnalength_entry.grid(row=6, column=1)
    ...
    matingpool_multiple_entry.grid(row=7, column=1)
    ...
    keep_best_rate_entry.grid(row=8, column=1)
    ...
    max_fitness_entry.grid(row=9, column=1)
    ...
    forcednalength_entry.grid(row=0, column=1)
    ...
    selection_entry.grid(row=1, column=1)
    ...
    start_position_entry.grid(row=2, column=1)
    ...
    mutate_option_entry.grid(row=3, column=1)
    ...
    crossover_method_entry.grid(row=4, column=1)
    ...
    init_method_entry.grid(row=5, column=1)
